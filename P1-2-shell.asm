...
.data
			...
			nearArr: .word 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF     # Array of neighbor squares' values
			indexArr: .word 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF     # Array of neighbor squares' indices 
